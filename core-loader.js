    ...
    <div style="background:#fafafa;color:#212529;height:100vh;
      ...
      <div style="max-width:600px;background:white;padding:40px;border-radius:8px;
        ...
        <div style="border-top:1px solid #e9ecef;padding-top:20px;margin-top:30px;">
          <a href="https://help.shopify.com" target="_blank" style="color:#0066cc;text-decoration:none;margin-right:16px;">
            Shopify Help Center
          </a>
          <a href="https://help.shopify.com/en/questions" target="_blank" style="color:#0066cc;text-decoration:none;margin-right:16px;">
            Contact Support
          </a>
          <a href="https://admin.shopify.com" target="_blank" style="color:#0066cc;text-decoration:none;">
            Store Admin
          </a>
        </div>
      </div>
